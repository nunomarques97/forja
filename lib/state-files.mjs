...
// retried briefly. If replacement still fails, preserve the previous complete
// file and report the error to the caller.
...
// fail briefly with EPERM/EBUSY). Never truncate the target as a fallback.
