...
async function invoke(launch, payload, { onLaunch = () => {} } = {}) {
  ...
  if (outer.interrupted) throw new RunStop('interrupted', 'Isolated check interrupted by the operator; no check result was recorded. Work on disk is preserved; resume with core resume.');
