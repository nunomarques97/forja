...
Validate JavaScript with the full suite and check script. On this Windows machine, `npm test -- --test-concurrency=2` avoids legacy maximum-concurrency timing stress. Browser changes require actual desktop/mobile screenshots. Do not push or modify the separate public repository.
